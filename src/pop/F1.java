...
public class F1 extends JopFrame implements JopUtilityIfc {
  JPanel contentPane;
  ...
  Grp59_	grp59_31;
  public F1( JopSession session, String instance, boolean scrollbar) {
    super( session, instance);
    this.scrollbar = scrollbar;
    geInit();
  }
  public F1( JopSession session, String instance, boolean scrollbar, boolean noinit) {
    super( session, instance);
    this.scrollbar = scrollbar;
    if ( !noinit)
      geInit();
